...
| Project | Variable must be set | Build option(s) | Package name  | Generated target |
|---------|----------------------|-----------------|---------------|---------------------|
| [imgui_club](https://github.com/ocornut/imgui_club) | IMGUI_CLUB_SOURCE_DIR | imgui_club | `imgui_club` | `Unofficial::imgui_club::imgui_club` |
